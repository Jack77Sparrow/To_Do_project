...
from app.db_sqlalchemy.models import session, CodewarsCompleted, User, Task, TaskTimeLogs
...
def save_completed_task_to_db(user_id: int):
    ...
    if newest_completed_at:
        ...
        if last_completed != newest_completed_at:
            ...
            print(f"Update codewars_last_completed for {query.codewars_username}")
        else:
            print(f"Nowthing new")
